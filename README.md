...
The full methodology, rules of evidence, and deliverables are specified in MISSION.md, which is committed first to timestamp the approach before any data is collected.
